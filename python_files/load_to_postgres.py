# Import libraries
from python_files.transform_file import transform
from python_files.extract_file import extract
...
# Config file path
config = load_config("/Users/jbshome/Desktop/tlc_application_etl/config/config.json")
